"""
Django settings for tri_state_removals_44145 project.
...
ROOT_URLCONF = 'tri_state_removals_44145.urls'
...
WSGI_APPLICATION = 'tri_state_removals_44145.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tri_state_removals_44145 API",
    "DESCRIPTION": "API documentation for tri_state_removals_44145 App",
    "VERSION": "v1",
}
